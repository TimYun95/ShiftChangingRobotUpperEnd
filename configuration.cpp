...
const std::string Configuration::nvhsoftStopFilePath = Configuration::mainFolder + "/system_files/nvhsoftStop.txt";
...
const std::string Configuration::nvhslowlyBrakeFilePath = Configuration::mainFolder + "/system_files/nvhslowlyBrake.txt";
