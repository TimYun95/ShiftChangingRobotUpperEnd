...
//    LockMutex();
    ...
    if(rem != 0){
        ...
        if (!RobotParams::ifCSACD)
        {
            ...
            //if(pdRobot->modelSelect==1){//修改  online模式还要修改过
            //  pdRobot->RunMyPID();
            //}

            if(pdRobot->modelSelect==2){//ACD模式2 Predefined
                pdRobot->RunAccOpenValue2();
                pdRobot->RunBrakeOpenValue2();
                pdRobot->RunCarSpeed2();
            }
...
void PedalRobotUI::on_pushButton_softStop_clicked()
{
    ...
    pdRobot->FinishQCustomPlotSpeed(false);
}
...
void PedalRobotUI::UpdateWidgets()
{
    ...
    //修改2/////////////////////////////////////////////////////////////////////////
    ui->lineEdit_showAccOpenValue->setText(QString::number(pdRobot->GetAcceleratorPosition()));
    ui->lineEdit_showCarSpeed->setText(QString::number(pdRobot->GetMyCarSpeed()));
    ui->lineEdit_showScaraTheta1->setText(QString::number(RobotParams::angleRealTime[1]));

    ui->lineEdit_showBrakeOpenValue->setText(QString::number(pdRobot->GetBrakePosition()));
    ui->lineEdit_showScaraTheta0->setText(QString::number(RobotParams::angleRealTime[0]));
    //修改2/////////////////////////////////////////////////////////////////////////

    //修改12/////////////////////////////////////////////////////////////////////////
    ui->lineEdit_showOnlineModel->setText(QString::number(pdRobot->myGetCmndMd));
    if(pdRobot->myGetCmndMd==0){
        ui->lineEdit_showOnlineValue->setText(QString::number(pdRobot->myGetVehStSpd));
        ui->lineEdit_showOnlineDelay->setText(QString::number(0));
    }

    if(pdRobot->myGetCmndMd==1){
        ui->lineEdit_showOnlineValue->setText(QString::number(pdRobot->myGetAcclStPos));
        ui->lineEdit_showOnlineDelay->setText(QString::number(pdRobot->myGetAcclDlyTmr));
    }

    if(pdRobot->myGetCmndMd==2){
        ui->lineEdit_showOnlineValue->setText(QString::number(pdRobot->myGetBrkPdlStPos));
        ui->lineEdit_showOnlineDelay->setText(QString::number(pdRobot->myGetBrkPdlDlyTmr));
    }
    ...
    static bool isswitchflag[10] = {!RobotParams::switchflag[0], !RobotParams::switchflag[1], !RobotParams::switchflag[2], !RobotParams::switchflag[3], !RobotParams::switchflag[4], !RobotParams::switchflag[5], !RobotParams::switchflag[6], !RobotParams::switchflag[7], !RobotParams::switchflag[8], !RobotParams::switchflag[9]};
    ...
    if ( !pdRobot->isStateIdle() )
    {
        if(RobotParams::ifGoHome != isGoHomedLast || RobotParams::ifConfirmSC != isConfirmSCLast || RobotParams::ifConfirmCS != isConfirmCSLast ||
           ...
           RobotParams::switchflag[3] != isswitchflag[3] || RobotParams::switchflag[4] != isswitchflag[4] || RobotParams::switchflag[5] != isswitchflag[5] ||
           RobotParams::switchflag[6] != isswitchflag[6] || RobotParams::switchflag[7] != isswitchflag[7] || RobotParams::switchflag[8] != isswitchflag[8] ||
           RobotParams::switchflag[9] != isswitchflag[9] || RobotParams::isExaming != isisExaming){ // 状态有变化
            ...
            isswitchflag[5] = RobotParams::switchflag[5];
            isswitchflag[6] = RobotParams::switchflag[6];
            isswitchflag[7] = RobotParams::switchflag[7];
            isswitchflag[8] = RobotParams::switchflag[8];
            isswitchflag[9] = RobotParams::switchflag[9];
